...
Set-Location "C:\Users\tonyd\OneDrive - 4Sight Education Ltd\Apps\DASHBOARD\DASHBOARD\vue-dashboard"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "The App Loader is configured to load from: https://cdn.jsdelivr.net/gh/4Sighteducation/vespa-dashboard@vue/dist/" -ForegroundColor Yellow
} else {
