...
onMounted(async () => {
  ...
  // Check if Cycle 3 data exists
  // This would be determined by checking if any students have Cycle 3 data
  hasCycle3Data.value = false // Set based on actual data check
})
...
const generateReport = async () => {
  ...
  try {
    ...
    const requestData = {
      ...
      // Include current dashboard data
      currentData: {
...
const saveReportConfiguration = () => {
  ...
  console.log('Configuration saved:', configurationName.value)
}
</script>
